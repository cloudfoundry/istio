...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mtls_root', full_name='istio.mesh.v1alpha1.MeshConfig.mtls_root', index=33,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mtls_cert', full_name='istio.mesh.v1alpha1.MeshConfig.mtls_cert', index=34,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mtls_key', full_name='istio.mesh.v1alpha1.MeshConfig.mtls_key', index=35,
